...
// Возможно потребуется изменить делитель частоты 8 на другое значение
create_generated_clock -name clk_divider/clk_div_reg_0 -source [get_ports {clk}] -divide_by 8 [get_pins {clk_divider/clk_div_reg/Q}]
